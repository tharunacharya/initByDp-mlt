    ...
    <div class="wrapper">
        ...
        <header>
            ...
            <div class="container-fluid d-flex justify-content-between">
                ...
                <!--SOS button  -->
                <!--<div id="sos-button-container" class="sos-button-container  d-flex justify-content-center align-items-center mr-4 ">-->
                <!--    <button id="sos-button" class="btn btn-danger" data-user-id="{{ Auth::user()->id }}">SOS</button>-->
                <!--</div>-->
                <!--SOS button  -->
                ...
                @else
                    <div class="login-container">
                        <div class="login-popup-trigger d-flex justify-content-center align-items-center" data-target="login-popup">
                            ...
                            <img src="{{ asset('assets/images/frontend-icons-fleet-login2.png')}}" alt="">
                        </div>
