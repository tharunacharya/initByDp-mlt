...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <!--  <h3 class="card-title">MLT Admins &nbsp;-->
    ...
    <h3 class="card-title">{{ $title }} &nbsp;
      @can('Users add')
        <a href="{{ route('users.create') }}" class="btn btn-success" title="@lang('fleet.addUser')">
...
$('#mlt-admins-btn').on('click', function() {
    window.location.href = "{{ url('admin/users') }}?user_type=M";
});

$('#client-admins-btn').on('click', function() {
    window.location.href = "{{ url('admin/users') }}?user_type=O";
});


// to filter the admins
// $(function(){
//     var userType = "{{ $userType }}"; // Pass the user type from Blade to JavaScript
...
//             type: 'POST',
//             data: function (d) {
//                 d.user_type = userType; // Include user type in the request data
//             }
//         },
//         columns: [
//             {data: 'check', name: 'check', searchable: false, orderable: false},
...
$(function(){
    ...
    // Handle admin assignment change event
