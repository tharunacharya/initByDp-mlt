...
<div class="invoice p-3 mb-3">
    ...
    <div class="col-12">
      <h4>
        ...
        <small class="float-right"> <b>@lang('fleet.date') : </b>{{
          date($date_format_setting, strtotime(optional($i->booking_income)->date)) }}</small>
      </h4>
    </div>
  </div>
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      <b>@if(optional($booking->customer)->getMeta('address') != null)@lang('fleet.To') @endif</b>
      <address>
        {!! nl2br(e(optional($booking->customer)->getMeta('address'))) !!}
      </address>
    </div>
    <div class="col-sm-4 invoice-col">
      <b>@lang('fleet.invoice')#</b>
      <b>@lang('fleet.tax_no')</b>
      {{Hyvikk::get('tax_no')}}
      <br>
      <b>Invoice#</b>
      {{ $i['income_id'] }}
      <br>
      <b>{{ optional($booking->customer)->name }}</b>
    </div>
  </div>
  <div class="row">
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            ...
            <td>
              {{ optional($booking->vehicle)->make_name }} - {{ optional($booking->vehicle)->model_name }} - 
          ...
          <tr>
            ...
            <td>{{ optional($i->booking_income)->mileage }} {{ Hyvikk::get('dis_format') }}</td>
          </tr>
          <tr>
            <th>@lang('fleet.waitingtime'):</th>
            <td>
              {{ optional($booking)->getMeta('waiting_time') }}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>{{ Hyvikk::get('currency') }} {{ optional($i->booking_income)->amount }}</td>
          </tr>
        </table>
      </div>
    </div>
