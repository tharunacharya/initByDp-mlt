      ...
      <div class="sidebar">
        ...
        <div class="form-inline">
         ...
         with font-awesome or any other icon font library -->
              ...
              @if((Request::is('admin/drivers*')) || (Request::is('admin/users*')) || (Request::is('admin/users?user_type=O'))  || (Request::is('admin/customers*'))
              ...
              <li class="nav-item has-treeview {{$class}}">
                ...
                <ul class="nav nav-treeview">
                 ...
                 <!--@can('Users list')-->
                 <!--   <li class="nav-item">-->
                 <!--     <a id="client-admins-btn" class="nav-link  @if(Request::is('admin/users/client-admins')) active @endif">-->
                 <!--         <i class="fa fa-user nav-icon"></i>-->
                 <!--       <p>Client Admins</p>-->
                 <!--     </a>-->
                 <!--   </li>-->
                ...
                <ul class="nav nav-treeview">
                 ...
                 @if (!Auth::guest() && Auth::user()->user_type != "D" && Auth::user()->user_type != "C" && Auth::user()->user_type != "M"  && Auth::user()->user_type != 'O')
                  <li class="nav-item">
               ...
               @endif
                    ...
                    <li class="nav-item">
                      <a href="{{ route('users.index', ['user_type' => 'O']) }}" id="client-admins-btn" class="nav-link  ">
                          <i class="fa fa-user nav-icon"></i>
                        <p>Client Admins</p>
                      </a>
                    </li>
